					...
					$output .= '<div class="post-desc-wrapper '. $item_bg_class .'" style="'. esc_attr($bg_color) .'">';
						$output .= '<div class="post-desc">';
							...
							$output .= '<div class="post-head">';
								...
								if ($show_meta) {
									$output .= '<span class="custom_cat_feild">' . get_the_category_list(', ') . '</span>';
									$output .= '<div class="post-meta clearfix">';
								
									
								
									// Existing author-date section
									...
									if (isset($list_meta['author'])) {
										...
										$output .= '<span class="post_by"> Posted by </span>';
									...
									// Adding post-comments for Masonry Tiles style
							...
							$output .= '<div class="post-title">';
								...
								if( get_post_format() == 'quote' ){
									...
									$output .= '<h4 class="entry-title" itemprop="headline"><a href="'. esc_url(get_permalink()) .'">'. wp_kses(get_the_title(), mfn_allowed_html()) .'</a></h4>';
							...
							if( ! in_array( $style, array('photo','photo2','masonry tiles') ) && ( !empty(mfn_love()) || ( comments_open() && mfn_opts_get( 'blog-comments' ) ) || !empty($attr['more']) ) ){
								$output .= '<div class="post-footer">';
									...
									$output .= ' <a href="'. esc_url(get_permalink()) .'" class="post-more"> View Post </a> <i class="fas fa-chevron-circle-right" aria-hidden="true"></i>';
									// $output .= '<div class="post-links">';
									// 	if( comments_open() && mfn_opts_get( 'blog-comments' ) ){
									// 		$output .= '<i class="icon-comment-empty-fa" aria-label="'. __('number of comments', 'betheme') .'"></i> <a href="'. esc_url(get_comments_link()) .'" class="post-comments">'. esc_html(get_comments_number()) .'</a>';
									// 	}
