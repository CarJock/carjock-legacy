        ...
        <div>
            <span class="relative z-0 inline-flex shadow-sm rounded-md">
                ...
                <span class="active" aria-current="page">
                    <span style="background:#49a94d" class="text-white relative inline-flex items-center px-4 py-2 -ml-px text-sm font-medium text-gray-500 border border-gray-300 cursor-default leading-5">{{ $page }}</span>
                </span>
                @else
