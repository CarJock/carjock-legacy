...
<section class="faQ">
    <div class="container">
        ...
        <div class="text">
            <h5>{{$faqs_content->short_heading}}</h5>
            <h2><span>{{$faqs_content->heading}}</span></h2>
            <P>{{$faqs_content->content}}</P>
        </div>
            ...
            <div class="col-8">
                <div class="faqs-box">
                    <div class="accordion">
                        ...
                        @foreach($faqs as $faq)
                        <div class="step">
                            <input id="step-{{$i}}" type="checkbox" class="step-checkbox">
                            <div class="step-inner">
                                <label for="step-{{$i}}" class="header">
                                    <span class="title">{{$faq->question}}</span>
                                    <span class="dropdown-btn">
                                        <img decoding="async" class="plus"
                                            src="{{ asset('frontend/assets/images/accordianopen.png') }}"
                                            alt="plus icon">
                                        <img decoding="async" class="minus"
                                            src="{{ asset('frontend/assets/images/accordianclose.png') }}"
                                            alt="minus icon">
                                    </span>
                                </label>
                                <div class="body"><p>{{$faq->description}}</p></div>
                            </div>
                        </div>
                        @php 
                            if ($i == $divide)
