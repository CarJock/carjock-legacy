    ...
    <div class="col-md-4 carcard firstcomparision" style="display: none">
        ...
        <div class="inner">
            <div class="imageholder">
                <img src="{{ asset('frontend/assets/images/comparision-placeholder.jpeg') }}" class="vehicle-image" alt="comparision">
                <div class="iconholder">
                    @if (Auth::check())
                    <a class="favourite-vehicle" title="Add to favorite" href="javascript:;" ><button><i class="fas fa-heart"></i></button></a>
                    @else
                    <a title="Add to favorite" href="javascript:;" data-toggle="modal" data-target="#login-alert"><button><i class="fas fa-heart"></i></button></a>
                    @endif
                    <a title="Share"  href="javascript:;"  class="socialshare"><button><i class="fal fa-share-alt"></i></button></a>
                ...
                <div class="hidesocial socialshare-detail">
                    ...
                    <div class="">
                        <div class="social-share-links">
                            ...
                            <a  target="_blank">
                                <div class="twitter">
                                    <img style="width:16px" alt="twitter sharing button" src="https://platform-cdn.sharethis.com/img/twitter.svg">
        ...
        <div class="inner">
            <div class="imageholder">
                ...
                <div class="iconholder">
                    @if (Auth::check())
                    <a class="favourite-vehicle" title="Add to favorite" href="javascript:;"><button><i class="fas fa-heart"></i></button></a>
                    <a title="Share"  href="javascript:void(0)" class="socialshare"><button><i class="fal fa-share-alt"></i></button></a>
                    @if(!isset($simple))
