            ...
            <div class="row">
               <div class="relatedCar text-center new_sec_add">
                  ...
                  <div id="tab2" class="tab-content mb-3" style="display: block">
                     ...
                     <?php if($garage->isNotEmpty()): ?>
                     <hr>

                     <div id="tab1" class="tab-content active">

                           <?php $__currentLoopData = $garage; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $vehicle): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                           <div class="row hello_check">
                              ...
                              <div class="flex">
                                 <a href="<?php echo e(route('frontend.compare', ['comparisions' => $vehicle->id])); ?>">
                                    <button type="submit" class="btn btn-primary check_four mr-2">Compare</button>
                                 </a>
                                 <a onclick="deleteGarage('<?php echo e($vehicle->id); ?>', '<?php echo e(route('frontend.account.garage.delete', $vehicle->id)); ?>')" data-link="<?php echo e(route('frontend.account.garage.delete', $vehicle->id)); ?>" href="javascript:;">
...
<?php $__env->startPush('script'); ?>
   ...
   <script>
      $(".search-field").change(function() {
         ...
         $.get("<?php echo e(url('ajax/query/chromedata')); ?>", {
            type : $(this).attr('name'),
            value : $(this).val(),
                        ...
                        vehicles += '<div class="imgBox">';
                           ...
                           vehicles += '</div>';
                              ...
                              vehicles += '<div class="vehicleSpec">';
                                 vehicles += '<ul>';
                                    vehicles += '<li class="first"><img src="<?php echo e(asset("frontend/assets/images/engine.png")); ?>" alt=""> ' + (vehicle_data?.engine.length > 0 ? vehicle_data.engine[0]?.horsepower?.value : vehicle_data?.engine.horsepower?.value) + ' Horsepower</li>';
                                    vehicles += '<li><img src="<?php echo e(asset("frontend/assets/images/fuel-pump.png")); ?>" alt=""> '+vehicle.mpg_city+' MPG</li>';
                                    vehicles += '<li><img src="<?php echo e(asset("frontend/assets/images/all-wheel-drive.png")); ?>" alt="">'+vehicle_data.style?.drivetrain+'</li>';
                                    vehicles += '<li class="last"><img src="<?php echo e(asset("frontend/assets/images/seats.png")); ?>" alt="">'+vehicle.seating+' Passengers</li>';
                                 vehicles += '</ul>';
...
<?php echo $__env->make('frontend.layouts.app', ['class' => 'login'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/carjock/resources/views/frontend/auth/garage.blade.php ENDPATH**/ ?>