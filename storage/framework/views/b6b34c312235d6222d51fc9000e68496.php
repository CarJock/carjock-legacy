<?php $__env->startSection('content'); ?>
    ...
    <div class="blog-container">
        <section id="featured-blog">
            <img src="<?php echo e(url('/storage/blogs/dummy_blog.jpg')); ?>"
        ...
        <section id="posts">
            <article>
                <img src="<?php echo e(url('/storage/blogs/dummy_blog2.png')); ?>" alt="Car Image">
            ...
            <article>
                <img src="<?php echo e(url('/storage/blogs/dummy_blog3.jpg')); ?>" alt="Car Image">
                <h2>2024’s Best Cars to Drive</h2>
                <p>April 10, 2024 | Posted by admin</p>
                <a href="#">View Post</a>
            </article>
            <article>
                <img src="<?php echo e(url('/storage/blogs/dummy_blog4.jpg')); ?>" alt="Car Image">
                <h2>2024’s Best Cars to Drive</h2>
                <p>April 10, 2024 | Posted by admin</p>
                <a href="#">View Post</a>
            </article>
...
<?php echo $__env->make('frontend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/carjock/resources/views/blogs/index.blade.php ENDPATH**/ ?>