<footer>
   <div class="footerWrapper">
      <div class="container-fluid">
         <div class="row">
            ...
            <div class="col-md-4">
               <div class="widget">
                  <img src="<?php echo e(asset('frontend/assets/images/footerLogo.png')); ?>" alt="">
            ...
            <div class="col-md-4 new_change">
               <div class="widget">
                  ...
                  <ul class="useFullLinks">
                     <li><a href="<?php echo e(route('frontend.aboutus')); ?>"><i class="far fa-chevron-double-right"></i>About Us</a></li>
                     <li><a href="<?php echo e(route('frontend.contact')); ?>"><i class="far fa-chevron-double-right"></i>Contact Us</a></li>
                     <li><a href="<?php echo e(route('frontend.disclaimer')); ?>"><i class="far fa-chevron-double-right"></i>Disclaimer</a></li>
                     <li><a href="<?php echo e(route('frontend.faqs')); ?>"><i class="far fa-chevron-double-right"></i>FAQ</a></li>
                     <li><a href="<?php echo e(url('/')); ?>/blogs"><i class="far fa-chevron-double-right"></i>Blogs</a></li>
                     <li><a href="<?php echo e(route('frontend.search')); ?>"><i class="far fa-chevron-double-right"></i>Search</a></li>
                     <li><a href="<?php echo e(route('frontend.privacy-policy')); ?>"><i class="far fa-chevron-double-right"></i>Privacy</a></li>
                     <li><a href="<?php echo e(route('frontend.term-conditions')); ?>"><i class="far fa-chevron-double-right"></i>Terms & Conditions</a></li>
                     <li><a href="<?php echo e(route('frontend.account.profile')); ?>"><i class="far fa-chevron-double-right"></i>My Profile</a></li>
                  </ul>
               </div>
            </div><!-- // COl // -->
   ...
   <div class="copyright">
      <div class="row">
         ...
         <div><?php echo date("Y"); ?>-<a herf="/" style="color:green;">CarJock</a> All Rights Reserved</div>
...
<script>
   $('#subscription_form').on('submit', function(e) {
      ...
      if (emailPattern.test(subscriptions_email)) {
         ...
         $.ajax({
            url: "<?php echo e(route('frontend.subscribe')); ?>",
            method: 'POST',
            data: {
   ...
   function adsClicks(page_id, slot=0) {
      $.ajax({
         url: "<?php echo e(route('frontend.ads-clicks')); ?>",
         method: 'POST',
         data: {
            _token: '<?php echo e(csrf_token()); ?>',
            page_id: page_id,
...
<?php /**PATH C:\Users\nitin\OneDrive\Desktop\carjock-legacy\resources\views/frontend/layouts/footer.blade.php ENDPATH**/ ?>