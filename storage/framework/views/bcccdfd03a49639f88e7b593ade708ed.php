    ...
    <div class="container-fluid">
        <div class="row">
            <div class="mainbanneroverlay">
                ...
                <p style="color:#fff;"><?php echo e($banner->content); ?></p>    
                </div>
            </div>
...
<div class="compare-body">
    <div class="customize-container">
        ...
        <div class="row carcomparisonsection">
            <div class="col-md-9">
                <?php echo $__env->make('frontend.compare-layouts.select-comparisions', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                ...
                <div class="selectcarcards">
                    <div class="top select-vehicle">
                        <div class="iconholderbtn">
                            <img src="<?php echo e(asset('frontend/assets/images/iconcarsselector.svg')); ?>" alt="">
                        </div>
                        <div class="note">
        ...
        <div class="comaprisionblock">
            <div class="row foundcomparisionresult">
                <div class="col-md-3">
                    <?php echo $__env->make('frontend.compare-layouts.sidebar-filters', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                </div>
                <div class="col-md-9">
                    ...
                    <div class="selectedcarsstrip resetfiltersettings" style="display:none">
                        ...
                        <div class="col-auto class_flexauto_adj">
                            <div class="buttons">
                                ...
                                <?php else: ?>
                                <button type="button"
                                    onclick="window.location.href = '<?php echo e(route('frontend.login', ['redirect' => route('frontend.compare')])); ?>'">Login
                                    to save</button>
                                <?php endif; ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('frontend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/carjock/resources/views/frontend/compare.blade.php ENDPATH**/ ?>