                        ...
                        <form method="POST" action="<?php echo e(route('admin.contents.update', $contents->id)); ?>" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea required class="form-control"
                                    name="content" rows="6"><?php echo e($contents->content); ?></textarea>
                            </div>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/carjock/resources/views/admin/content-management/page-contents/edit.blade.php ENDPATH**/ ?>